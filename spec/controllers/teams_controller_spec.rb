...
RSpec.describe TeamsController, type: :controller do
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Team" do
        expect {
          post :create, {:organization_id => organization.to_param, :team => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved team as @team" do
        post :create, {:organization_id => organization.to_param, :team => invalid_attributes}, valid_session
        expect(assigns(:team)).to be_a_new(Team)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the teams list" do
      delete :destroy, {:id => team.to_param}, valid_session
      expect(response).to redirect_to(organization_teams_url(organization))
    end
  end
