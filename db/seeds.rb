...
2.times do
  ...
  survey = create(:survey_template, organization: org)
  create :survey_question, survey_template: survey, title: 'Support',
  ...
  create :survey_question, survey_template: survey, title: 'Teamwork',
  ...
  create :survey_question, survey_template: survey, title: 'Pawns/Players',
  ...
  create :survey_question, survey_template: survey, title: 'Mission',
  ...
  create :survey_question, survey_template: survey, title: 'Codebase Health',
  ...
  create :survey_question, survey_template: survey, title: 'Ease of Release',
  ...
  create :survey_question, survey_template: survey, title: 'Learning',
      text: 'Awesome: We’re learning lots of interesting stuff all the time! OR: We never have time to learn anything'
  create :survey_question, survey_template: survey, title: 'Delivering Value',
  ...
  create :survey_question, survey_template: survey, title: 'Suitable Process',
  ...
  create :survey_question, survey_template: survey, title: 'Fun',
